...
def strict_filter(rulebook: str, previous_context: str, tool_call: str) -> Tuple[bool, dict]:
    ...
    prompt = """
        ...
        The decision MUST be grounded ONLY in the provided rulebook text.
        ...
        - Reply with EXACTLY one of:
          - ALLOW
          - FORBIDDEN BY <law reference>
        - Do NOT include any extra words, punctuation, or explanations.
        - If blocking, cite the most relevant law reference you can find in the rulebook
          (e.g., "HIPAA 164.502" or "GDPR Art.9"). If the rulebook has no explicit indices,
          cite the closest available heading/title.
    """
